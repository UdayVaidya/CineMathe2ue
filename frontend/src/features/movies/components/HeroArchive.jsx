export default function HeroArchive({ movie }) {
    ...
    return (
        <section className="relative w-full h-[70vh] flex items-end border-b-2 border-[#e63946] overflow-hidden group">
            ...
            {/* Background Image with Grayscale & Blur */}
            <div
                className="absolute inset-0 bg-cover bg-center grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-90 transition-all duration-[3s] ease-out"
